var Recorder = {
    ...
    record: function(a) {
        ...
        this.bind("recordingStart", a.start),
        this.bind("recordingProgress", a.progress),
        this.bind("recordingCancel", a.cancel),
    ...
    play: function(a) {
        ...
        this.bind("playingProgress", a.progress),
        this.bind("playingStop", a.finished),
        this.flashInterface()._play()
    },
    upload: function(a) {
        a.audioParam = a.audioParam || "audio",
        a.params = a.params || {},
        this.clearBindings("uploadSuccess"),
        this.bind("uploadSuccess", function(b) {
    ...
    bind: function(a, b) {
        Recorder._events[a] || (Recorder._events[a] = []),
        Recorder._events[a].push(b)
    },
    ...
    registerCallback: function(a) {
        ...
        return Recorder._callbacks[b] = a,
        b
    },
    ...
    _loadFlash: function() {
        ...
        a.setAttribute("id", "recorderFlashObject"),
        this.options.flashContainer.appendChild(a),
    ...
    _defaultOnShowFlash: function() {
        ...
        a.style.left = (window.innerWidth || document.body.offsetWidth) / 2 - 115 + "px",
        a.style.top = (window.innerHeight || document.body.offsetHeight) / 2 - 70 + "px"
    },
...
if (swfobject == undefined) var swfobject = function() {
    ...
    function F() {
        ...
        if (b > 0) for (var c = 0; c < b; c++) {
            ...
            if (y.pv[0] > 0) {
                var g = P(d);
                if (g) if (S(m[c].swfVersion) && !(y.wk && y.wk < 312)) U(d, !0),
...
window.SC.URI = function(a, b) {
    ...
    this.toString = function() {
        ...
        a += this.path,
        this.path === "" && (this.query != null || this.fragment != null) && (a += "/"),
    ...
    this.decodeParams = function(a) {
        ...
        c = {},
        i = a.split("&");
        for (g = 0, h = i.length; g < h; g++) d = i[g],
        d !== "" && (e = d.split("="), b = decodeURIComponent(e[0]), f = decodeURIComponent(e[1] || "").replace(/\+/g, " "), this.normalizeParams(c, b, f));
        return c
    },
    this.normalizeParams = function(a, b, c) {
        ...
        f = h[1] || "",
        d = h[2] || "",
        d === "" ? a[f] = c : d === "[]" ? (a[f] || (a[f] = []), a[f].push(c)) : (i = d.match(/^\[\]\[([^\[\]]+)\]$/) || (i = d.match(/^\[\](.+)$/))) ? (e = i[1], a[f] || (a[f] = []), g = a[f][a[f].length - 1], g != null && g.constructor === Object && g[e] == null ? this.normalizeParams(g, e, c) : a[f].push(this.normalizeParams({},
        e, c))) : (a[f] || (a[f] = {}), a[f] = this.normalizeParams(a[f], d, c)),
        a
    },
    this.encodeParamsWithPrepend = function(a, b) {
        var c;
        return c = this.encodeParams(a),
        c !== "" ? b + c : ""
    },
    this.encodeParams = function(a) {
        ...
        b = this.flattenParams(a),
        d = [];
        for (h = 0, i = b.length; h < i; h++) e = b[h],
        c = e[0],
        g = e[1],
        g === null ? d.push(c) : d.push(c + "=" + encodeURIComponent(g));
        return f = d.join("&")
    },
    this.flattenParams = function(a, b, c) {
        ...
        if (a == null) b != null && c.push([b, null]);
            ...
            f = a[d],
            b !== "" ? e = b + "[" + d + "]" : e = d,
            this.flattenParams(f, e, c)
        } else if (a.constructor === Array) for (g = 0, h = a.length; g < h; g++) f = a[g],
        this.flattenParams(f, b + "[]", c);
        else b !== "" && c.push([b, a]);
        return c
    },
    this.parse = function(a, b) {
        ...
        this.scheme = g(h[1]),
        e = h[2],
        e != null && (f = e.match(c), i = g(f[1]), i != null && (this.user = i.split(":")[0], this.password = i.split(":")[1]), this.host = g(f[2]), this.port = parseInt(f[3], 10) || null),
        this.path = h[3],
        this.query = g(h[4]),
        b.decodeQuery && (this.query = this.decodeParams(this.query)),
        this.fragment = g(h[5]);
        if (b.decodeFragment) return this.fragment = this.decodeParams(this.fragment)
    },
    this.parse(a.toString(), b),
    this
},
function() {
    ...
    SC.Helper = {
        ...
        extractOptionsAndCallbackArguments: function(a, b) {
            var c;
            return c = {},
            b != null ? (c.callback = b, c.options = a) : typeof a == "function" ? (c.callback = a, c.options = {}) : c.options = a || {},
            c
        },
        openCenteredPopup: function(a, b, c) {
            var d;
            return d = {},
            c != null ? (d.width = b, d.height = c) : d = b,
            d = SC.Helper.merge(d, {
                location: 1,
        ...
        setFlashStatusCodeMaps: function(a) {
            return a["_status_code_map[400]"] = 200,
            ...
            a["_status_code_map[504]"] = 200
        },
        responseHandler: function(a, b) {
            var c, d;
            return d = SC.Helper.JSON.parse(a),
            c = null,
            d ? d.errors && (c = {
    ...
    window.SC = SC.Helper.merge(SC || {},
    {
        ...
        initialize: function(a) {
            ...
            return (d = this.options).flashXHR || (d.flashXHR = (new XMLHttpRequest).withCredentials === void 0),
            this
        },
        hostname: function(a) {
            var b;
    ...
    window.SC = SC.Helper.merge(SC || {},
    {
        _apiRequest: function(a, b, c, d) {
            ...
            f.query.format = "json",
            SC.options.flashXHR ? SC.Helper.setFlashStatusCodeMaps(f.query) : f.query["_status_code_map[302]"] = 200;
            if (a === "PUT" || a === "DELETE") f.query._method = a,
            a = "POST";
            return a !== "GET" && (e = f.encodeParams(f.query), f.query = {}),
            this._request(a, f, "application/x-www-form-urlencoded", e, function(a, b) {
                var c;
                return c = SC.Helper.responseHandler(a, b),
                c.json && c.json.status === "302 - Found" ? SC._apiRequest("GET", c.json.location, d) : d(c.json, c.error)
            })
        },
        ...
        _xhrRequest: function(a, b, c, d, e) {
            var f;
            return f = new XMLHttpRequest,
            f.open(a, b.toString(), !0),
            f.setRequestHeader("Content-Type", c),
        ...
        "delete": function(a, b) {
            return this._apiRequest("DELETE", a, {},
            b)
        },
        prepareRequestURI: function(a, b) {
            ...
            return d.isRelative() && (d.host = this.hostname("api"), d.scheme = "http"),
    ...
    window.SC = SC.Helper.merge(SC || {},
    {
        ...
        connect: function(a) {
            ...
            if (c.client_id && c.redirect_uri) return b = SC.dialog(SC.Dialog.CONNECT, c, function(a) {
                ...
                SC.accessToken(a.access_token),
                d.connected != null && d.connected();
                if (d.callback != null) return d.callback()
            }),
            this._connectWindow = b.options.window,
            b;
        ...
        accessToken: function(a) {
            var b, c;
            return c = "SC.accessToken",
            b = this.storage(),
            a === void 0 ? b.getItem(c) : a === null ? b.removeItem(c) : b.setItem(c, a)
        },
    ...
    window.SC = SC.Helper.merge(SC || {},
    {
        ...
        dialog: function(a, b, c) {
            var d, e, f;
            return d = SC.Helper.extractOptionsAndCallbackArguments(b, c),
            f = d.options,
            c = d.callback,
            f.callback = c,
            f.redirect_uri = this.options.redirect_uri,
            e = new SC.Dialog[a + "Dialog"](f),
            SC.Dialog._dialogs[e.id] = e,
            e.open(),
            e
        },
        Dialog: {
            ...
            _getDialogIdFromWindow: function(a) {
                ...
                b = c.query.state || c.fragment.state,
                this._isDialogId(b) ? b : null
            },
            _handleDialogReturn: function(a) {
                var b, c;
                c = this._getDialogIdFromWindow(a),
                b = this._dialogs[c];
            ...
            AbstractDialog: AbstractDialog = function() {
                function a(a) {
                    this.options = a != null ? a : {},
                    this.id = this.generateId()
                }
                return a.prototype.WIDTH = 456,
                a.prototype.HEIGHT = 510,
                a.prototype.ID_PREFIX = "SoundCloud_Dialog",
                a.prototype.PARAM_KEYS = ["redirect_uri"],
                a.prototype.requiresAuthentication = !1,
                ...
                a.prototype.buildURI = function(a) {
                    var b, c, d, e;
                    a == null && (a = new SC.URI(SC._baseUrl)),
                    a.scheme = "http",
                    a.path += SC._dialogsPath + "/" + this.name + "/",
                    a.fragment = {
                        state: this.id
                    },
                    this.requiresAuthentication && (a.fragment.access_token = SC.accessToken()),
                    e = this.PARAM_KEYS;
                    for (c = 0, d = e.length; c < d; c++) b = e[c],
                    this.options[b] != null && (a.fragment[b] = this.options[b]);
                    return a
                },
                ...
                a.prototype.authenticateAndOpen = function() {
                    ...
                    return a = SC.connect({
                        ...
                        connected: function() {
                            return b.options.window = a.options.window,
                            b.open()
                        }
                    })
                },
                ...
                a.prototype.handleReturn = function() {
                    var a;
                    return a = this.paramsFromWindow(),
                    this.options.retainWindow || this.options.window.close(),
            ...
            EchoDialog: EchoDialog = function(a) {
                ...
                b.prototype.PARAM_KEYS = ["client_id", "redirect_uri", "hello"],
                b.prototype.name = "echo",
                b
            } (AbstractDialog),
            PickerDialog: PickerDialog = function(a) {
                ...
                return __extends(b, a),
                b.prototype.PARAM_KEYS = ["client_id", "redirect_uri"],
                b.prototype.name = "picker",
                b.prototype.requiresAuthentication = !0,
                b.prototype.handleReturn = function() {
                    var a, b = this;
                    a = this.paramsFromWindow();
                    if (a.action === "logout") return SC.accessToken(null),
                    this.open(),
                    !1;
                    if (a.track_uri != null) return this.options.retainWindow || this.options.window.close(),
                    SC.get(a.track_uri, function(a) {
            ...
            ConnectDialog: ConnectDialog = function(a) {
                ...
                return __extends(b, a),
                b.prototype.PARAM_KEYS = ["client_id", "redirect_uri", "client_secret", "response_type", "scope", "display"],
                b.prototype.name = "connect",
                b.prototype.buildURI = function() {
                    var a;
                    return a = b.__super__.buildURI.apply(this, arguments),
                    a.scheme = "https",
                    a.host = "soundcloud.com",
                    a.path = "/connect",
                    a.query = a.fragment,
                    a.fragment = {},
                    a
        ...
        Loader: {
            ...
            Package: function(a, b) {
                return {
                    ...
                    setReady: function() {
                        return this.state = SC.Loader.States.READY,
                        this.runCallbacks()
                    },
                    load: function() {
                        return this.state = SC.Loader.States.LOADING,
                        this.loadFunction.apply(this)
                    },
    ...
    window.SC = SC.Helper.merge(SC || {},
    {
        ...
        recordUpload: function(a, b) {
            var c, d;
            return a == null && (a = {}),
            d = SC.prepareRequestURI("/tracks", a),
            d.query.format = "json",
            ...
            Recorder.upload({
                ...
                success: function(a) {
                    var c;
                    return c = SC.Helper.responseHandler(a),
                    b(c.json, c.error)
                }
            })
        }
    ...
    window.SC = SC.Helper.merge(SC || {},
    {
        ...
        _prepareStreamUrl: function(a) {
            var b, c;
            return a.toString().match(/^\d.*$/) ? c = "/tracks/" + a : c = a,
            b = SC.prepareRequestURI(c),
            b.path.match(/\/stream/) || (b.path += "/stream"),
            b.toString()
        },
        _setOnPositionListenersForComments: function(a, b, c) {
            var d, e, f, g;
            e = SC.Helper.groupBy(b, "timestamp"),
            g = [];
            for (f in e) d = e[f],
            g.push(function(b, c, d) {
        ...
        stream: function(a, b, c) {
            ...
            SC.whenStreamingReady(function() {
                var b, d;
                return e.id = "T" + a + "-" + Math.random(),
                e.url = f._prepareStreamUrl(a),
                b = function(a) {
                    var b;
                    return b = soundManager.createSound(a),
                    c != null && c(b),
                    b
                },
                (d = e.ontimedcomments) ? (delete e.ontimedcomments, SC._getAll(e.url.replace("/stream", "/comments"), function(a) {
                    var c;
                    return c = b(e),
                    f._setOnPositionListenersForComments(c, a, d)
                })) : b(e)
            })
        },
